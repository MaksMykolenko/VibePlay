...
export const CreatorAnalytics: React.FC = () => {
  return (
    <div style={containerStyle} className="animate-fade">
      ...
      <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem' }}>Deep-dive analysis of your audience engagements, retention curves, and performance stats.</p>
        ...
        <div style={boxStyle} className="bg-glass">
          ...
          <div style={demoRowStyle}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={barBgStyle}><div style={{ ...barFgStyle, width: '45%', backgroundColor: 'var(--secondary)' }}></div></div>
            </div>
          </div>
          <div style={demoRowStyle}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={barBgStyle}><div style={{ ...barFgStyle, width: '35%', backgroundColor: 'var(--primary)' }}></div></div>
            </div>
          </div>
          <div style={demoRowStyle}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={barBgStyle}><div style={{ ...barFgStyle, width: '20%', backgroundColor: 'var(--success)' }}></div></div>
            </div>
          </div>
        </div>
        ...
        <div style={boxStyle} className="bg-glass">
          ...
          <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'center', marginTop: '0.5rem' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '0.75rem', color: 'var(--text-secondary)' }}>Average session duration (desktop)</div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '0.75rem', color: 'var(--text-secondary)' }}>Day-7 player return rate</div>
            </div>
          </div>
        </div>
      ...
      <div style={alertBoxStyle} className="bg-glass">
        ...
        <span style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', lineHeight: 1.4 }}>
          Analytics metrics refresh once every 24 hours. Connect your Google Analytics tags or NeoFlux pixels inside Settings to track custom in-game event triggers.
        </span>
      </div>
